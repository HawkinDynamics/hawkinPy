...
#--------------------#    
## Tests by Group
def GetTestsGroup(token, groupId: str, from_: int = None, to_: int = None, sync: bool = False, active: bool = True) -> pd.DataFrame:
    """Fetches and returns test trials for specified group(s) from an API, using an authentication token managed by a TokenManager instance.
